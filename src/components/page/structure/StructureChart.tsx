    ...
    <div className="mx-auto max-w-6xl space-y-8 px-4 pb-12 sm:px-7">
      <div className="list-chart flex flex-col items-center justify-center space-y-8 text-sm font-semibold transition-all lg:space-y-16">
        ...
        <div className="mb-8 grid gap-x-9 lg:grid-cols-3">
          <div className="level-2 relative hidden max-w-xs rounded-md bg-sky-700 px-11 py-3 text-center text-primary-foreground before:absolute before:inset-y-0 before:left-full before:my-auto before:h-1 before:w-[4.5rem] before:bg-sky-300 sm:before:w-20 md:px-10 md:before:w-20 lg:inline-block lg:before:w-[5.5rem]">
            Secretariat
          </div>
