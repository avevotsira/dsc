export const ui: Record<string, Record<string, string>> = {
  en: {
    ...
    "nav.mediaHub": "Media Hub",
    "nav.mediaHub.legislations": "Legislations",
    "nav.mediaHub.policies": "Policies",
    "nav.mediaHub.pressRelease": "Press Release",
    "nav.newEvent": "News & Events",
    "nav.cybersecurityTips": "Cybersecurity Tips",
  ...
  km: {
    ...
    "nav.exploreDSC.DSCstructure": "រចនាសម្ព័ន្ធ គ.ស.ឌ.",
    "nav.exploreDSC.DSCChairRemarks": "សុន្ទរកថាដ៏ខ្ពង់ខ្ពស់របស់ប្រធាន គ.ស.ឌ.",
    "nav.exploreDSC.DSCUnits": "អង្គភាពក្រោមឱវាទ គ.ស.ឌ.",
    "nav.mediaHub": "បណ្តុំឯកសារ",
    "nav.mediaHub.legislations": "ច្បាប់ និងលិខិតបទដ្ឋានគតិយុត្ត",
    "nav.mediaHub.policies": "គោលនយោបាយ",
    "nav.mediaHub.pressRelease": "សេចក្តីប្រកាសព័ត៌មាន",
    ...
    "about.dscText1.part1":
      "នៅឆ្នាំ ២០២១ ដើម្បីធានាឱ្យបាននូវការអភិវឌ្ឍសេដ្ឋកិច្ច និងសង្គមឌីជីថលរស់រវើកសម្រាប់ព្រះរាជាណាចក្រកម្ពុជា រាជរដ្ឋាភិបាលកម្ពុជា ក្រោមការដឹកនាំដ៏ខ្ពង់ខ្ពស់របស់ ",
    "about.dscText1.part2":
    ...
    "about.dscText2":
      "យោងតាមក្របខណ្ឌគោលនយោបាយសេដ្ឋកិច្ច និងសង្គមឌីជីថលកម្ពុជា ២០២១-២០៣៥ ក្រុមប្រឹក្សាជាតិសេដ្ឋកិច្ច និងសង្គមឌីជីថលជាតិមានគណៈកម្មាធិការចំនួនបីបំពេញមុខងារជាសេនាធិការទទួលខុសត្រូវលើការងារបច្ចេកទេសជាក់លាក់។ គណៈកម្មាធិការទាំងនេះរួមមាន៖",
    "about.committeeList1":
      "គណៈកម្មាធិការសេដ្ឋកិច្ច និង ធុរកិច្ចឌីជីថល (បង្កើតឡើងក្នុង ឆ្នាំ២០២១)",
    "about.committeeList2":
      "គណៈកម្មាធិការរដ្ឋាភិបាលឌីជីថល (បង្កើតឡើងក្នុង ឆ្នាំ២០២២)",
